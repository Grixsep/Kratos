...
beam_waist_diameters = [0.02, 0.025, 0.03]
...
for i, diameter in enumerate(beam_waist_diameters):
    ...
    modified_data['output_processes']['gid_output'][0]['Parameters']['output_name'] = f"gid_output/waist_{i}/axisym_ablation_plus_thermal_problem"
    ...
    print(f'Created {output_filename} with beam_waist_diameter = {diameter} and output_name = gid_output/waist_{i}/axisym_ablation_plus_thermal_problem')
