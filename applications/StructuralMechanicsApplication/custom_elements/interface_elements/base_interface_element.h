 ...
 */
class KRATOS_API(STRUCTURAL_MECHANICS_APPLICATION) BaseInterfaceElement
    : public Element
{
protected:
    /**
...
public:
    ...
    // Counted pointer of BaseInterfaceElement
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION( BaseInterfaceElement );
    ...
    BaseInterfaceElement( IndexType NewId, GeometryType::Pointer pGeometry ):Element(NewId,pGeometry)
    {};

    // Constructor using an array of nodes with properties
    BaseInterfaceElement( IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties ):Element(NewId,pGeometry,pProperties)
    {
    ...
    // Copy constructor
    BaseInterfaceElement(BaseInterfaceElement const& rOther)
        :BaseType(rOther)
        ,mThisIntegrationMethod(rOther.mThisIntegrationMethod)
    {};

    // Destructor
    ~BaseInterfaceElement() override
    {};
