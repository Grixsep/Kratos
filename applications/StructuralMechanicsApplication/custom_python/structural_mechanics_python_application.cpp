...
PYBIND11_MODULE(KratosStructuralMechanicsApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MODAL_MASS_MATRIX_X )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MODAL_MASS_MATRIX_Y )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MODAL_MASS_MATRIX_Z )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TOTAL_MODAL_MASS )
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,BEAM_PRESTRESS_PK2)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STRESS_XX)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STRESS_YY)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STRESS_ZZ)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m,  POINT_STRESS )
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, THICKNESS_EFFECTIVE_Y );
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, USE_LUMPED_MASS_MATRIX);

    // Variables for the boundary conditions in seismic problems
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, WAVE_VELOCITY_P);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, WAVE_VELOCITY_S);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NORMAL_DIRECTION );
