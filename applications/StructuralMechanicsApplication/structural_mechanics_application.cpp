...
void KratosStructuralMechanicsApplication::Register() {
    ...
    // Condition stress variables
    KRATOS_REGISTER_VARIABLE( STRESS_XX )
    KRATOS_REGISTER_VARIABLE( STRESS_YY )
    KRATOS_REGISTER_VARIABLE( STRESS_ZZ )
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(POINT_STRESS)
