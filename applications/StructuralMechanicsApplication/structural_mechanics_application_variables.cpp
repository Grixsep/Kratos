...
KRATOS_CREATE_VARIABLE(Matrix, MODAL_MASS_MATRIX_X)
KRATOS_CREATE_VARIABLE(Matrix, MODAL_MASS_MATRIX_Y)
KRATOS_CREATE_VARIABLE(Matrix, MODAL_MASS_MATRIX_Z)
KRATOS_CREATE_VARIABLE(double, TOTAL_MODAL_MASS)
...
KRATOS_CREATE_VARIABLE(double, AXIAL_STRAIN)
KRATOS_CREATE_VARIABLE(double, SHEAR_STRAIN)
KRATOS_CREATE_VARIABLE(double, BENDING_STRAIN)
...
KRATOS_CREATE_VARIABLE(Vector, BEAM_PRESTRESS_PK2)
...
KRATOS_CREATE_VARIABLE(double, STRESS_XX)
KRATOS_CREATE_VARIABLE(double, STRESS_YY)
KRATOS_CREATE_VARIABLE(double, STRESS_ZZ)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(POINT_STRESS)
...
KRATOS_CREATE_VARIABLE(double, THICKNESS_EFFECTIVE_Y );
...
KRATOS_CREATE_VARIABLE(bool, USE_LUMPED_MASS_MATRIX );

// Variables for the boundary conditions in seismic problems
KRATOS_CREATE_VARIABLE(double, WAVE_VELOCITY_P );
KRATOS_CREATE_VARIABLE(double, WAVE_VELOCITY_S );
KRATOS_CREATE_VARIABLE(double, NORMAL_DIRECTION );
